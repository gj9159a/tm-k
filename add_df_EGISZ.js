            ...
            if (createButton.textContent === 'Поехали!' && remdOidInput.style.display === 'block') {
                ...
                for (let scenario of scenarios) {
                    let fieldsTemplate = [
                        ...
                        {name: 'id_case_result', label: 'Результат осмотра', model: 'DynamicObjects', scenarios: 'scenario', type: 'ac', config: '{"position":"0.15","elementOrder":1,"defaultValue":"Без перемен","readonly":true}', position: '0.15'},
                        ...
                        {name: 'word8', label: 'Диагноз ЕГИСЗ', model: 'DynamicObjects', scenarios: 'scenario', type: 'ac', config: '{"position":"0.2","elementOrder":1,"egisz_name":["DynamicObjects","MkbCode"],"additionalACValue":[{"key_index":"dictionary_param1","value":"dictionary_param1","element":"word9"}],"readonly":true}', position: '0.2'},
