...
(function() {
    ...
    setTimeout(function() {
        ...
        let items = [
            {
                name: 'Протокол консультации (CDA) Редакция 4 v240903',
                shown_at: 'Динамические сущности',
                document_name_template: 'Протокол консультации (CDA) Редакция 4 v240903',
            ...
            if (createButton.textContent === 'Поехали!' && remdOidInput.style.display === 'block') {
                ...
                for (let scenario of scenarios) {
                    let fieldsTemplate = [
                        ...
                        {name: 'remd_document_title', label: 'Заголовок документа РЭМД', model: 'DynamicObjects', scenarios: 'scenario', type: 'text', config: '{"position":"0.291","elementOrder":1,"defaultValue":"Протокол консультации врача терапевта"}', position: '0.291'},
