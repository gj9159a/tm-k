// ==UserScript==
// @name         update_accountSettingsAdmin
// @namespace    http://tampermonkey.net/
// @version      1.0.0
// @description  улучшение админпанели настроек (для суперадминки)
// @author       gj9159a
// @match        https://klientiks.ru/clientix/admin/accountSettings/*
// @match        https://klientiks.ru/clientix/admin/accountsettings/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=klientiks.ru
// @grant        none
// @updateURL    https://raw.githubusercontent.com/gj9159a/tm-k/main/update_accountSettingsAdmin.js
// @downloadURL  https://raw.githubusercontent.com/gj9159a/tm-k/main/update_accountSettingsAdmin.js
// ==/UserScript==
...
(function() {
    ...
    setTimeout(function() {
        var container = document.querySelector('#accountSettingsAdmin');
        if (container) {
